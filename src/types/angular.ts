...
export interface AngularGuardOptionsSchema {
     ...
     * @minItems 1
     */
    implements?: ['CanActivate' | 'CanActivateChild' | 'CanDeactivate' | 'CanLoad' | 'CanMatch', ...('CanActivate' | 'CanActivateChild' | 'CanDeactivate' | 'CanLoad' | 'CanMatch')[]];
}
/**
 ...
 */
export interface ProtractorTarget {
    /**
